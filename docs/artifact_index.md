...
| EfficientAT post-formal exploration | `docs/experiments/pretrained-cnn-postformal-exploration.md` | MN20 三 seed、checkpoint averaging 與 focal-loss development-only 比較 | 執行中 | folds 1/4/7 validation only | 禁止重新評估 test；artifacts 將備份至 Drive `pretrained_cnn_postformal/` |
