...
| EfficientAT bold breakthrough study | `docs/experiments/pretrained-cnn-bold-breakthrough.md`、`configs/pretrained_cnn_bold_*.yaml`、`scripts/run_pretrained_cnn_bold_study.py` | MN30/MN40、BatchNorm freeze 與 cross-scale ensemble 的 post-formal development-only 比較 | 待執行 | folds 1/4/7；fold 10 sealed | Drive `pretrained_cnn_bold_breakthrough/`；不得提交 checkpoints/results |
