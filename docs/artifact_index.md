...
| Pretrained CNN development runner | `src/train_pretrained_cnn.py`、`scripts/run_pretrained_cnn_transfer.py` | folds 1、4、7 linear probe / partial fine-tuning | 已確認 | tests + Colab A100 | 只依 validation Macro F1 mean/std；支援鎖定後一次 test |
