...
| EfficientAT bold breakthrough study | `docs/experiments/pretrained-cnn-bold-breakthrough.md`、`configs/pretrained_cnn_bold_*.yaml`、`scripts/run_pretrained_cnn_bold_study.py` | MN30/MN40、BatchNorm freeze 與 cross-scale ensemble 的 post-formal development-only 比較 | 已完成 | 33 manifests + folds 1/4/7 validation only | MN20+MN40 seed-42 F1 `0.90128 ± 0.00982`；MN40 3-seed F1 `0.89440 ± 0.00651`；Drive `pretrained_cnn_bold_breakthrough_b6848c1_20260817_130915/`；未評估 test |
